...
//                bw.write("System time: " + new java.util.Date() + "\n");
                ...
                BufferedWriter bw2 = new BufferedWriter(new FileWriter("output.csv", true));
//                bw2.write( "Problem,Method,VAH,Nodes,Backtracks,Runtime(ms)\n");
...
//                    bw.write("Backtracks: " + csp.backtracks + "\n");
                    ...
                    bw2.write(readFile.getName().split("\\.")[0] + "," + csp.getClass().getName() + "," + vah.getClass().getName()
                            + "," + csp.totalNodes + "," + csp.backtracks + "," + (endTime - startTime) / 1000000 + "\n");
